...
```{r}
model_4<-lm(BPSysAve~BMI+Age+Gender+Race1+Education+DirectChol+Diabetes+PhysActiveDays+AlcoholYear+SmokeNow+Age*Gender+Gender*DirectChol+BMI*Race1+DirectChol*Diabetes,data=comp_cases)
summary(model_4)
